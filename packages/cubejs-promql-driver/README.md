...
Promql driver.
Works with Prometheus and Cortex.

[Learn more](https://github.com/cube-js/cube.js#getting-started)

### Support

This driver has been contributed by Cube.js community member [Daniel Garcia](https://github.com/daniel-garcia). This package is **community supported** and should be used at your own risk. 
...
Cube.js Promql Driver is [Apache 2.0 licensed](./LICENSE).
